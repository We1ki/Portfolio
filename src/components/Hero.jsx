  ...
  return (
    ...
    <section className="hero" ref={heroRef}>
      ...
      <div className="hero-socials">
        <a className="lin" href="https://www.linkedin.com/in/ibai-iturriagaetxebarria-romero-a02845337/?trk=opento_sprofile_details">
        ...
        <a className="gith" href="https://github.com/We1ki">
